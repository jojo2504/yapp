...
#[case( // Correct
    Job {
        ...
        tests: vec![
            TestCase { problem_id: 1, input: "1 2".to_string(), expected: "3".to_string(), hidden: false }, 
            TestCase { problem_id: 2, input: "2 4".to_string(), expected: "6".to_string(), hidden: false }
        ]
    },
    Submission::new(1, 1, 1, Language::Rust, "".to_string())
        .verdict(Verdict::Accepted)
        .test_results(vec![
            TestCaseResult {verdict:Verdict::Accepted, test_case_id: 1, execution_time: 0, memory_kb: 0, stdout: Some(String::from("hello world")) },
            TestCaseResult {verdict:Verdict::Accepted, test_case_id: 2, execution_time: 0, memory_kb: 0, stdout: Some(String::from("hello world")) }
        ])
        .build()
)]
...
#[case( // Error code runtime but first testcase works
    Job {
        ...
        tests: vec![
            TestCase { problem_id: 1, input: "1 2".to_string(), expected: "3".to_string(), hidden: false }, 
            TestCase { problem_id: 2, input: "2 4".to_string(), expected: "6".to_string(), hidden: false },
            TestCase { problem_id: 3, input: "1 2".to_string(), expected: "3".to_string(), hidden: false },
            TestCase { problem_id: 4, input: "1 6".to_string(), expected: "7".to_string(), hidden: false },
        ]
    },
    Submission::new(1, 1, 1, Language::Rust, "".to_string())
        .verdict(Verdict::RuntimeError)
        .test_results(vec![
            TestCaseResult { test_case_id: 1, verdict: Verdict::Accepted, execution_time: 0, memory_kb: 0, stdout: None }, 
            TestCaseResult { test_case_id: 2, verdict: Verdict::RuntimeError, execution_time: 0, memory_kb: 0, stdout: Some(String::from("hello world")) },
            TestCaseResult { test_case_id: 3, verdict: Verdict::Accepted, execution_time: 0, memory_kb: 0, stdout: None },
            TestCaseResult { test_case_id: 4, verdict: Verdict::RuntimeError, execution_time: 0, memory_kb: 0, stdout: None  }
        ])
        .build()
)]
